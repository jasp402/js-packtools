 ...
 * {@version 1.2.0 | last Update: Sun Nov 03 2019 09:05:25 GMT-0500 (GMT-05:00) 
...
const sourceLib 		 = [{"name":"allEqual","category":"Arrays/Object","description":"This snippet checks whether all elements of the array are equal.","version":"1.0.0"},{"name":"clearFolders","category":"Path/Files","description":"This simply clear the content a folder.","version":"1.0.0"},{"name":"createFolders","category":"Path/Files","description":"This create a folder whit sub-folder of date by default if param `withDate` is True.","version":"1.0.0"},{"name":"csvToJson","category":"convert","description":"This read a document CSV and convert in a Object Javascript (JSON).","version":"1.0.0"},{"name":"customDate","category":"Time/Date","description":"It's a date control. Without parameters give the current date, use the parameters to customize its functionality.","version":"1.0.0"},{"name":"deleteFile","category":"Path/Files","description":"Check if the file exists before deleting","version":"1.0.0"},{"name":"differenceDay","category":"Time/Date","description":"This simply clear the content a folder.","version":"1.0.0"},{"name":"everyOrNone","category":"Arrays/Object","description":"This snippet returns true if the predicate function returns true for all elements in a collection and false otherwise. \\n You can omit the second argument fn if you want to use Boolean as a default value.","version":"1.0.0"},{"name":"formatSeconds","category":"Time/Date","description":"This only format a value float","version":"1.0.0"},{"name":"generateRageDate","category":"Time/Date","description":"This function allows you to separate a given date in the number of days assigned to it.","version":"1.0.0"},{"name":"getFinalPath","category":"Path/Files","description":"Create structure of folders with parameters in constructor.","version":"1.0.0"},{"name":"groupBy","category":"Arrays/Object","description":"Sort the object by placing the value of the assigned property as key","version":"1.0.0"},{"name":"increaseDays","category":"Time/Date","description":"Add days to date, can defined a maxDate.","version":"1.0.0"},{"name":"objectToDate","category":"Time/Date","description":"Generate a object with date details.","version":"1.0.0"},{"name":"parseDate","category":"Time/Date","description":"Using a string and a format transform the string in date.","version":"1.0.0"},{"name":"validateDir","category":"Path/Files","description":"Validate if there is a route. if not, create this route.","version":"1.0.0"},{"name":"validateYear","category":"Time/Date","description":"Can be current year or spend the year to validate","version":"1.0.0"},{"name":"writeLog","category":"global","description":"write file .log in folder default of class.","version":"1.0.0"},{"name":"writeLogError","category":"global","description":"write file .log in folder default of class.","version":"1.0.0"},{"name":"log","category":"global","description":"It integrates the functions registry of errors and registry of execution for the document of registry in his project.","version":"1.0.0"}];
class parameters {
    constructor(config={}){
