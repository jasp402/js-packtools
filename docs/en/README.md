...
|---|---|---|---|
|🌱  [**allEqual**](https://jasp402.github.io/js-packtools/#/en/api/v1/allEqual)  | 1.0.0 | Arrays/Object | <sub>This snippet checks whether all elements of the array are equal.</sub> |
...
| Functions Name | version | Category | Description |
|---|---|---|---|
|🌱  [**capitalLetter**](https://jasp402.github.io/js-packtools/#/en/api/v1/capitalLetter)  | 1.1.0 | String | <sub>capitalize the first letter of a sentence.</sub> |
...
| Functions Name | version | Category | Description |
|---|---|---|---|
|🌱  [**clearFolder**](https://jasp402.github.io/js-packtools/#/en/api/v1/clearFolder)  | 1.0.0 | Path/Files | <sub>This simply clear the content a folder.</sub> |
