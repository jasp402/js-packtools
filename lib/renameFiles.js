 ...
 * @param  {null} opts - date `or` token `or` null ~ Unique identifier for each file in the folder null = self increasing
 ...
 */
module.exports = function(path, name, opts=null, rand=1) {
    const fs = require('fs');
